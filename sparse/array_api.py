...
def load_sparse(data_path: str, coords_path=None, coords_dict_path=None, shape=None, sparse_reference_value=0):
    """
    ...
    return SparseArray(data_path, coords_path, coords_dict_path, shape, sparse_reference_value, mode='r')
